...
mod tests {
    ...
    struct MockMessenger {
        ...
        // interior mutability
        // send method will be able to modify sent_messages to store the messages we’ve seen
    ...
    impl Messenger for MockMessenger {
        fn send(&self, message: &str) {
            // We call borrow_mut on the RefCell<Vec<String>> in self.sent_messages to get a mutable reference
            self.sent_messages.borrow_mut().push(String::from(message));
            // wrong because immutable borrow
